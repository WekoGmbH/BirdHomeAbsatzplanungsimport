...
{
    /// <summary>
    /// Exception für fehlerhafte Datenaktualisierungen
    /// </summary>
    [Serializable()]
    public class DataUpdateException : Exception
    {
        ...
        public DataUpdateException(string message, Exception inner) : base(message, inner)
        {
        }

        protected DataUpdateException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context) : base(info, context)
        {
        }
    }
}